                ...
                <ul class="dropdown-menu dropdown-materi shadow-lg border-0 p-2">
                    <li>
                        <button class="dropdown-item dropdown-materi-item fw-semibold"
                                ...
                                data-bs-target="#modalMateri1"
                                data-title="Pemformatan Teks">
                            ✍️ Pemformatan Teks
                        </button>
                    </li>
                    ...
                    <li>
                        <button class="dropdown-item dropdown-materi-item fw-semibold"
                                data-bs-toggle="modal"
                                data-bs-target="#modalMateri2"
                                data-title="Pemformatan Paragraf">
                    ...
                    <li>
                        <button class="dropdown-item dropdown-materi-item fw-semibold"
                                data-bs-toggle="modal"
                                data-bs-target="#modalMateri3"
                                data-title="Pembuatan List Terstruktur">
