...
<div class="modal fade" id="modalMateri6" tabindex="-1" aria-hidden="true"
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content rounded-4 shadow-lg d-flex flex-column">
            ...
            <div class="modal-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="modal-title fw-bold mb-0">📚 Integrasi Elemen Audio</h5>
                ...
                <div class="row g-4">
                        ...
                        <div class="sidebar-sticky">
                            <div class="nav flex-column nav-pills sidebar-tab">
                                <button class="nav-link active" data-bs-toggle="pill"
                                        data-bs-target="#materi6-praktik">
                                    🧩 Materi & Praktik
                                </button>
                                ...
                                <button class="nav-link" data-bs-toggle="pill"
                                        data-bs-target="#materi6-project">
                                    🚀 Mini Project
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            ...
                            <!-- =========================
                            1. MATERI & PRAKTIK (DRAG DROP - AUDIO)
                            ========================== -->
                            <div class="tab-pane fade show active" id="materi6-praktik">

                                <p class="text-secondary small">
                                    Pelajari fungsi setiap atribut audio, lalu lengkapi kode HTML agar audio dapat diputar dengan benar.
                                </p>
...
<span class="tag">&lt;h1&gt;</span>Integrasi Elemen Audio HTML5<span class="tag">&lt;/h1&gt;</span>
...
<span class="tag">&gt;</span>
    ...
    <span class="tag">&lt;source</span>
        <span class="attr">src</span>=<span class="drop-slot" data-answer="&quot;audio-belajar.mp3&quot;"></span>
        <span class="attr">type</span>=<span class="drop-slot" data-answer="&quot;audio/mpeg&quot;"></span>
    <span class="tag">/&gt;</span>
...
<span class="tag">&lt;/audio&gt;</span>
                                    ...
                                    <div class="col-md-5">
                                        <div class="bg-light rounded-4 p-3 h-100 d-flex flex-column">
                                            ...
                                            <h6 class="fw-bold text-primary mb-3">
                                                🧠 Penjelasan Tag & Atribut Audio
                                            </h6>

                                            <ul class="list-explain">
                                                <li><span>&lt;audio&gt;</span> Menampilkan audio di halaman web</li>
                                                <li><span>controls</span> Menampilkan kontrol audio</li>
                                                <li><span>autoplay</span> Audio diputar otomatis</li>
                                                <li><span>loop</span> Audio diputar berulang</li>
                                                ...
                                                <li><span>&lt;source&gt;</span> Menentukan sumber dan tipe audio</li>
                                            </ul>

                                            <div class="alert alert-info mt-3 small">
                                                💡 <strong>Catatan:</strong><br>
                                                Browser modern biasanya <b>memerlukan atribut muted</b>
                                                agar <b>autoplay</b> dapat berjalan.
                                            </div>
                                            ...
                                            <div class="drag-box" id="dragSource6">
                                                ...
                                                <div class="drag-item" draggable="true" data-code="&quot;audio-belajar.mp3&quot;">"audio-belajar.mp3"</div>
                                                <div class="drag-item" draggable="true" data-code="&quot;audio/mpeg&quot;">"audio/mpeg"</div>
                                            </div>

                                            <div class="alert alert-info small mt-3" id="dragFeedback6">
                                                Lengkapi semua slot agar audio dapat diputar dengan benar.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="materi6-live">
                                ...
                                <ul class="small">
                                    <li>Tambahkan kembali 1 audio dengan penamaan file audio "musik.mp3"</li>
                                    <li>Tambahkan minimal 2 atribut dalam tag &lt;audio&gt;</li>
                                </ul>
...
{{-- tulis disini... --}}
                            ...
                            <!-- =========================
                            3. MINI PROJECT (AUDIO)
                            ========================== -->
                            <div class="tab-pane fade" id="materi6-project">

                                <div class="alert alert-success small">
                                    Buat halaman HTML sederhana dengan ketentuan:
                                    <ul class="mb-0">
                                        <li>1 judul (&lt;h1&gt;)</li>
                                        <li>1 elemen audio (&lt;audio&gt;)</li>
                                        <li>Menggunakan tag &lt;source&gt;</li>
                                        <li>Minimal 3 atribut audio</li>
                                        <li>Format dan penamaan file audio HTML5 (musik.mp3)</li>
                                    </ul>
                                </div>

                                <textarea class="project-editor"
                                    placeholder="Tulis kode HTML audio kamu di sini..."></textarea>

                                <button class="btn btn-primary mt-3" id="submitProject6">
                                    Cek Project
                                </button>

                                <div class="mt-3" id="projectResult6"></div>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const submitBtn = document.getElementById('submitProject6');
    const projectEditor = document.querySelector('.project-editor');
    const resultBox = document.getElementById('projectResult6');
    ...
    submitBtn.addEventListener('click', () => {
        ...
        const checks = [
            ...
            {
                label: 'Elemen Audio (<audio>)',
                valid: /<audio[\s\S]*?>[\s\S]*?<\/audio>/.test(code),
                descOk: 'Elemen <audio> sudah digunakan.',
                descFail: 'Tambahkan elemen <audio>...</audio>.'
            },
            {
                label: 'Tag Source (<source>)',
                valid: /<source/.test(code),
                descOk: 'Tag <source> sudah digunakan sebagai sumber audio.',
                descFail: 'Tambahkan tag <source> di dalam <audio>.'
            },
            {
                label: 'Minimal 3 atribut audio',
                valid: (
                    code.match(/(controls|autoplay|loop|muted|preload)/g) || []
                ).length >= 3,
                descOk: 'Atribut audio sudah digunakan dengan baik.',
                descFail: 'Gunakan minimal 3 atribut audio (contoh: controls, autoplay, muted).'
            },
            {
                label: 'Format Audio HTML5 (mp3)',
                valid: /audio\/mpeg/.test(code) || /\.mp3/.test(code),
                descOk: 'Format audio sudah menggunakan mp3.',
                descFail: 'Gunakan format audio HTML5 (.mp3).'
            }
        ];
        ...
        resultBox.innerHTML = `
            <div class="project-result">
                ...
                <ul class="project-result-list" id="resultList6"></ul>

                <div class="project-result-footer ${allCorrect ? 'success' : 'warning'}">
                    ${
                        allCorrect
                            ? 'Mantap! Audio HTML5 berhasil diintegrasikan 🎧'
        ...
        const list = document.getElementById('resultList6');
