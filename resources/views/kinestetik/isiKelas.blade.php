...
<div class="container py-5">
    ...
    <div class="tab-content" id="kelasTabContent">
        <div class="tab-pane fade show active" id="jelajah" role="tabpanel">@include('kinestetik.tabsKelas.jelajah')</div>
        <div class="tab-pane fade" id="kuis" role="tabpanel">@include('kinestetik.tabsKelas.kuis')</div>
        <div class="tab-pane fade" id="leaderboard" role="tabpanel">@include('kinestetik.tabsKelas.leaderboard')</div>
        ...
        <div class="tab-pane fade" id="livecode" role="tabpanel">@include('kinestetik.tabsKelas.livecode')</div>
    </div>
</div>
@endsection
