...
<div class="sidebar" id="sidebar">
    ...
    <div class="menu-item {{ $isKinestetik ? '' : 'locked' }}"
         @if($isKinestetik) onclick="location.href='{{ route('berandaKinestetik') }}'" @endif>
        <i class="bi bi-house-door"></i><span>Beranda</span>
    </div>

    <div class="menu-item {{ $isKinestetik ? '' : 'locked' }}"
         @if($isKinestetik) onclick="location.href='{{ route('petunjukKinestetik') }}'" @endif>
...
<nav class="navbar custom-nav shadow-sm sticky-top px-3">
    ...
    <button class="btn btn-light me-2 rounded-circle shadow-sm {{ $isKinestetik ? '' : 'locked' }}"
            id="toggleSidebar">
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow">
                <li>
                    <a class="dropdown-item" href="{{ route('profileKinestetik') }}">
