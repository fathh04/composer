...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="menu-item @yield('menuBeranda')" onclick="location.href='{{ route('berandaKinestetik') }}'">
            <i class="bi bi-house-door"></i><span>Beranda</span>
        </div>
        <div class="menu-item @yield('menuPetunjuk')" onclick="location.href='{{ route('petunjukKinestetik') }}'">
            <i class="bi bi-journal-text"></i><span>Petunjuk</span>
        </div>
        <div class="menu-item @yield('menuKelas')" onclick="location.href='{{ route('kelasKinestetik') }}'">
            <i class="bi bi-grid"></i><span>Kelas</span>
        </div>
        <div class="menu-item @yield('menuCPdanTP')" onclick="location.href='{{ route('CPdanTPKinestetik') }}'">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm mt-2 rounded-3">
                    <li><a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('profileKinestetik') }}">
